...
with open(f"C:/Users/Admin/Desktop/2025 Laboratory/Pressure Sensor/Pressure Logger/Results/Unlabeled Pressure Data from {currentTime}.csv", mode='w', newline='') as file:
